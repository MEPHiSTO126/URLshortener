      ...
      <div className="page">
        ...
        <section className="how-section">
          ...
          <div className="steps-row">
            {[
              { n: "1", emoji: "📋", name: "Paste Link", desc: "Copy any long URL and paste it into our secure input field above." },
              { n: "2", emoji: "⚙️", name: "Shorten", desc: "Our algorithm instantly generates a concise, memorable alias for your link." },
              { n: "3", emoji: "🚀", name: "Share & Track", desc: "Distribute your link and monitor detailed, real-time analytics data." },
            ].map((step, i, arr) => (
              <>
                <div className="step-connector" key={step.n}>
                ...
                {i < arr.length - 1 && <div className="step-arrow" key={`arrow-${i}`}>→</div>}
              </>
            ))}
          </div>
        </section>
        ...
        <footer>
          ...
          <div className="social-links">
            ...
            {/* GitHub */}
            <a href="https://github.com/MEPHiSTO126" className="social-link" aria-label="GitHub" target="_blank" rel="noreferrer noopener">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
            ...
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/" className="social-link" aria-label="LinkedIn" target="_blank" rel="noreferrer noopener">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
